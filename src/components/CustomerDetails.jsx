...
function CustomerDetails({ customer }) {
  ...
  return (
    <div>
      ...
      <button className="bg-indigo-500 mx-auto block transition-colors text-xl text-white uppercase hover:bg-indigo-700 w-40 h-12 md:px-4 md:mb-2 p-2 rounded-md sm:uppercase font-bold" type="button">Editar</button>
    </div>
  );
}
